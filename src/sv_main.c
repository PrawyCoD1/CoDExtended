...
#else
Huff_Decompress_t Huff_Decompress = (Huff_Decompress_t)0x807C793; //0x807C793 1.51, 1.1 0x8076C31
SV_GetClientScore_t SV_GetClientScore = (SV_GetClientScore_t)0x809C3AA; //0x809C3AA 1.51, 1.1 0x8092421
#endif
